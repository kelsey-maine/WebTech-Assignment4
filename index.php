...
<body style="width: 100%; max-width: 1000px; margin-left:auto; margin-right:auto">
	<div style="overflow:auto">
		<div class="img1container">
			<img src="images/University-of-Texas-San-Antonio-400x400.jpg" class="img1" width="150px">
		</div>
		<h1>Kelsey Maine</h1>
		<p style="text-decoration-line:underline">Software Engineer</p>
	</div>
	<hr style="margin-bottom:20px; clear:both;">
	<table style="min-height:50%; border-spacing:5px;">
		<tr>
			<?php
